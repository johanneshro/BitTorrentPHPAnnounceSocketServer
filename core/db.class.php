...
class db{
	...
	private function __construct()
	{
		...
		try {
			$this->dbh = new PDO('mysql:host='.$config['db_host'].';port='.$config['db_port'].';dbname='.$config['db_name'].';charset='.$config['db_charset'], $config['db_user'], $config['db_pass'] );
